...
Подпись отдельного контрола задаётся на нём самом и сильнее текстов приложения. Для плашки это опции `variablesEmpty` и `variablesSetupText` и их `data-*`. Подробнее —
