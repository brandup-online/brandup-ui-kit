...
function setup(value = "") {
	...
	// свойства подсвечиваются только при включённой персонализации
...
describe("MessageEditor highlighting", () => {
	...
	// В тексте показывается название свойства, но ключ обязан остаться: из него собирается
	...
	// У свойства с названием текст лежит глубже, в обёртке ключа, и край легко перепутать:
